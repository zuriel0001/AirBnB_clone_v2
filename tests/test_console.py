...
class TestConsole(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        """Set up the test env before running any test cases"""
        cls.consol = HBNBCommand()

    @classmethod
    def teardown(cls):
        """tear it down down console at the end of test"""
        del cls.consol

    def tearDown(self):
        """Remove all .json temporary files created"""
        try:
            os.remove("file.json")
    ...
    def test_docstrings_in_console(self):
        """check for all required docstrings"""
    ...
    def test_emptyline(self):
        """Test behavior when an empty line input"""
    ...
    def test_destroy(self):
        """Test behaviour of alternate destroy command input"""
        with patch('sys.stdout', new=StringIO()) as f:
